...
import com.intervigil.micdroiddonate.StartupDialog;

public class UpdateHelper {
	/* 
	 * One time updates when app has been updated goes here
	 * Currently we always show startup dialog, and reset default recording settings
	 */
	...
	private static void showStartupDialog(Context context) {
		StartupDialog startupDialog = new StartupDialog(context, 
				R.string.startup_dialog_title, R.string.startup_dialog_text, R.string.startup_dialog_accept_btn);
		startupDialog.show();
	}
